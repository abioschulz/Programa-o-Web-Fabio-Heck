package br.com.PortifolioProg.Web.Crud.services;
...
import br.com.PortifolioProg.Web.Crud.repositories.UserRepository;
...
public class UserService {
	...
	public User findById(Long id) {
		...
		return usuario.orElseThrow(() -> new ResouceNotFoutException(id));
	}
	
	public User inset(User usuario) {
	...
	public User update(Long id, User usuario) {
		...
		User cadrastro= repository.getReferenceById(id);
